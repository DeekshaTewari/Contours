...
%@gaborcontours/subsref Index function for GABORCONTOURS object.
...
case '.'
	...
	case 'mapfields'
		% pass remaining of index to parent
		[b,res] = subsref(obj.mapfields,index(2:end));
	otherwise
		unknown = 1;
	end
otherwise
...
if(unknown)
	[b,res] = subsref(obj.mapfields,index);
end
