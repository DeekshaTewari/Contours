function ContoursPlotUnleavedSpikes(spikes,cluster,target,argcatch)
%ContoursPlotUnleavedSpikes	Plot spike trains according to salience 
%conditions
%	ContoursPlotUnleavedSpikes(SPIKES,CLUSTER,TARGET,CATCH) creates 
