...
if ~isempty(lfpt)
    ...
    lfpctour = lfpcontourcoh('auto',varargin{:});
    lfpctrol = lfpcontrolcoh('auto',varargin{:});
    

    [difference,status] = compareLFPobj(lfpt,lfpctour,lfpctrol,varargin{:});
